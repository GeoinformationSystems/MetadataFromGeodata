...
//    }
    ...
    public void writeMetadataToDatabase(String datasetFilePath, MetadataDatabase metadataDatabase) {
        ...
        String sql3 = "INSERT INTO namespaces (name, link) VALUES(?,?)";
        ...
        try {
            ...
            PreparedStatement preparedStatementNamespace = this.connection.prepareStatement(sql3);
            ...
            // write namespaces to namespaces table
            for (int i = 0; i < metadataDatabase.namespaces.size(); i++) {
                preparedStatementNamespace.setObject(1, metadataDatabase.namespacePrefix.get(i));
                preparedStatementNamespace.setObject(2, metadataDatabase.namespaceURI.get(i));
                preparedStatementNamespace.executeUpdate();
            }
        } catch(SQLException e) {
            System.out.println(e.getMessage());
        }
