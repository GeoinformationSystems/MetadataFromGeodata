...
@javax.xml.bind.annotation.XmlSchema(
        ...
        xmlns ={@XmlNs(prefix="mdb", namespaceURI="http://standards.iso.org/iso/19115/-3/mdb/2.0"),
                @XmlNs(prefix="cat", namespaceURI="http://standards.iso.org/iso/19115/-3/cat/1.0"),
                @XmlNs(prefix="cit", namespaceURI="http://standards.iso.org/iso/19115/-3/cit/2.0"),
                ...
                @XmlNs(prefix="mac", namespaceURI="http://standards.iso.org/iso/19115/-3/mac/2.0"),
                ...
                @XmlNs(prefix="md1", namespaceURI="http://standards.iso.org/iso/19115/-3/md1/2.0"),
                @XmlNs(prefix="md2", namespaceURI="http://standards.iso.org/iso/19115/-3/md2/2.0"),
                @XmlNs(prefix="mda", namespaceURI="http://standards.iso.org/iso/19115/-3/mda/2.0"),
                @XmlNs(prefix="mds", namespaceURI="http://standards.iso.org/iso/19115/-3/mds/2.0"),
                @XmlNs(prefix="mdt", namespaceURI="http://standards.iso.org/iso/19115/-3/mdt/2.0"),
