...
public class DQM_Measure {
    ...
    private final String[] elementName = {"measureIdentifier", "Name", "alias", "elementName", "definition", "description", "valueType", "valueStructure", "example", "basicMeasure", "sourceReference", "parameter"};
    ...
    public List<String> elementName;
    ...
    public List<String> valueStructure;
    ...
    public void addValueStructure(String valueStructure) {
        int elementNum = 7;
        try {
            List<?> tempList = (List<?>) this.getClass().getField(elementName[elementNum]).get(this);
            if (tempList.size() >= elementMax[elementNum]) {
